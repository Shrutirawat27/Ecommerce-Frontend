        ...
        >
            <div className="p-4 mt-4">
                <div className="flex justify-between items-center mb-4">
                    ...
                    <button
                        onClick={() => onClose()}
                        className="text-gray-600 hover:text-gray-900"><img src="/close.png" alt="Close" className="w-7 h-7 p-1 text-white" />
                    </button> 
                </div>
                            ...
                            products.map((item, index) => (
                                <div key={index} className="flex flex-col md:flex-row md:items-center md:justify-between shadow-md md:p-5 p-2 mb-4">
                                    <div className="flex items-center">
                                        ...
                                        <img src={item.image1} alt="image" className="size-12 object-cover mr-4" />
                                        <div>
